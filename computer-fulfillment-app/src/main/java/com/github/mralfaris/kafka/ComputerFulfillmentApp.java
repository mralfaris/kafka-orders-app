...
public class ComputerFulfillmentApp {

	static Logger logger = LoggerFactory.getLogger(ComputerFulfillmentApp.class);	
	...
	private static void checkNewOrders() {
		...
		TopicPartition tp = new TopicPartition(orderTopic, 1);
